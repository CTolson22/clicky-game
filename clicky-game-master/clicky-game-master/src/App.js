            ...
            <div className="App">
                <header className="App-header">
                    ...
                    <p className="App-intro">
                        Try not to click the same image twice! </p>
                </header>
                ...
                <footer>
                    <p>Designed and built by Heather Mathies. You can find thecode
                        <a href="https://github.com/hmathies/Clicky-Game" target="_blank" rel="noopener noreferrer"> here</a>.</p>
                </footer>
            </div>
        );
    }
